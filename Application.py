...
class SchoolPortal():
    ...
    def __init__(self,root):
        ...
        self.label1 = Label(font=('arial',15,'bold'),text='School Database System', fg='dark blue')
    ...
    #----------------Add New Record--------------------
    def validation(self):
        return len(self.firstname.get()) != 0 and len(self.lastname.get()) != 0 and len(self.username.get()) != 0 \
               and len(self.email.get()) != 0 and len(self.subject.get()) != 0 and len(self.age.get()) != 0
